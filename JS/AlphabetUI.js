...
function AlphabetUI()
{	i=0;
	console.log("the alphabet part is running");
	Lheader("images/raw/alphabettitle.png");
	Lbodyalphabet("images/raw/Alphabets/Apple.png", "images/raw/Alphabets/Aa.png");
	Lfooter();
}
...
function Lbodyalphabet(objimage, objmaindisplay)
{	
...
function mySlidealphabet(param)
{
	if(param === 'next')
       {
                  i++;
                  if(i === imagesrawalphabet.length){ i = imagesrawalphabet.length - 1; }
         }
	else{
                  i--;
                  if(i < 0){ i = 0; }
    ...
    document.getElementById('slide').src = alphabetimages[i];
    document.getElementById('slide1').src = imagesrawalphabet[i];
}