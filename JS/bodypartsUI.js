...
function bodypartsUI()
{	
	i=0;
	console.log("the bodypart UI is running");
	Lheader("images/raw/bodypartstitle.png");
	Lbodyparts("images/raw/bodyparts/ear.png", "images/raw/bodyparts/1.png");
	Lfooter();
}
...
function Lbodyparts(objimage, objmaindisplay)
{	
...
function mySlidebodyparts(param)
{
	if(param === 'next')
       {
                  i++;
                  if(i === imagesrawbodyparts.length){ i = imagesrawbodyparts.length - 1; }
         }
	else{
                  i--;
                  if(i < 0){ i = 0; }
    ...
    document.getElementById('slide').src = bodypartsimages[i];
    document.getElementById('slide1').src = imagesrawbodyparts[i];
}